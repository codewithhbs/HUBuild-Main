...
const StepWizard = () => {
    ...
    const handleFetchmembership = async () => {
        try {
            const { data } = await axios.get("https://www.testapi.helpubuild.in/api/v1/get_all_membership");
    ...
    const fetchCurrentLocation = async () => {
        try {
            const res = await axios.post("https://www.testapi.helpubuild.in/Fetch-Current-Location", {
                lat: coords.latitude,
            ...
            if (order) {
                const options = {
                    ...
                    handler: async function (response) {
                        ...
                        try {
                            const { data } = await axios.post("https://www.testapi.helpubuild.in/api/v1/membership_payment_verify", {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("https://www.testapi.helpubuild.in/api/v1/register-provider", memberData);
    ...
    const handleCheckCouponCode = async (code = null) => {
        ...
        try {
            const res = await axios.post("https://www.testapi.helpubuild.in/api/v1/check_coupon_code", {
