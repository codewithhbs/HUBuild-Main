...
const VerifyEmail = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`https://api.helpubuild.in/api/v1/verify/email`, {
                email,
                otp: otpString,
            });
    ...
    const handleResend = async () => {
        if (canResend) {
            ...
            try {
                const response = await axios.post(`https://api.helpubuild.in/api/v1/resend-otp/email`, {
                    email,
                });
