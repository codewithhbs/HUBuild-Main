...
function AllBanner() {
    ...
    const handleFetchBanner = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('https://api.dessobuild.com/api/v1/get-all-banner');
    ...
    const handleUpdateActive = async (id, currentStatus) => {
        try {
            ...
            await axios.put(`https://api.dessobuild.com/api/v1/update-banner-status/${id}`, {
    ...
    const handleDeleteBanner = async (id) => {
        try {
            setLoading(true);
            await axios.delete(`https://api.dessobuild.com/api/v1/delete-banner/${id}`);
